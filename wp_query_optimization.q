...
trade:([] date:1000000?2019.12.01+til 31;time:asc 1000000?09:30:00.000 + til 21600000; sym:1000000?`GOOG`AMZN`FB; price:1000000?10.; size:1000000?1000000);
update price:?[`GOOG=sym;100.+price;?[`AMZN=sym;200.+price;price]]from `trade;
`date xasc trade

/- Create Partition for trade table
{(.Q.dd[hsym `$"/Users/utsav/db"]x,`$"trade/") set .Q.en[`:/Users/utsav/db;](delete date from select from trade where date=x)}@'distinct trade`date;
